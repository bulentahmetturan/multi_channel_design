...
4. Source monitoring (`radar/`) is a shared core serving every channel, built once in Phase 6 — not onboarded per channel. Each channel's own source list lives in its Channel Pack once monitoring begins.
