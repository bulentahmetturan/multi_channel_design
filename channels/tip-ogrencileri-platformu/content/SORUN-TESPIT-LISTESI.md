...
| S16 | Kaduse akışında eski/tarihsiz içerik (haber değeri yok, 2026'dayız) | RSS ve Google News kaynakları 2007-2022 tarihli girdiler de veriyor; tarih penceresi sadece Hekimler'de uygulanıyor; tarihsizler "1 gün" gibi çekilme yaşıyla taze görünüyor | Ölçüldü (2026-09-21): haber 797 kayıttan 213'ü 45 günden eski, 354 tarihsiz; araştırma 833'ten 143'ü 1 yıldan eski, 383 tarihsiz | S16, S16b | AÇIK: Kaduse için tarih penceresi + tarihsizi göstermeme kuralı, mevcut kayıtların temizliği (onay bekliyor) |
| S17 | Yinelenen başlıklar; konu dışı kayıtlar (sağlık dışı genel haber: EU politikası, "Kütüphane ve bilgi hizmetleri", birim adları) | Genel haber RSS'leri konu filtresiz; tekrarlayan başlıklar | Ölçüldü: 9 haber + 4 araştırma yinelenen başlık; anahtar kelime sezgisiyle ~283 haber / ~210 araştırma "konu dışı olabilir" (sezgi gürültülü) | S17 (yineleme) | AÇIK: feed başına konu kuralı gerekiyor (hangi feed kalacak kararı) |
| S18 | Yayın tarihi biçimleri karışık ("2026 Sep 7", RFC822, ISO); yaş etiketi tarihsizde çekilme zamanını gösteriyor | Tarih normalleştirme yok | Ölçüldü: araştırmada ~85 kayıt ISO dışı biçimde | - | AÇIK: ingest'te tarih normalleştirme, yaş etiketinde "tarih yok" |
